// The GIFT logo as a plain inline SVG (indigo shield + white G). Shared by the
// static hero fallback (HeroLogoSvg) and the animated SvgLogoHero so the two
// can never drift. Presentational only — no animation, no client hooks.

export default function GiftLogoMark({
  className,
  style,
}: {
  className?: string;
