        ...
        <dl className="mx-auto mt-14 max-w-4xl">
          {REASONS.items.map((item, i) => (
            <Reveal
              key={item.title}
              delay={i * 70}
              className="flex flex-col gap-y-2 border-t border-ai-border py-6 transition-colors duration-300 hover:border-ai-accent min-[760px]:flex-row min-[760px]:items-baseline min-[760px]:gap-x-10"
            >
              <dt
