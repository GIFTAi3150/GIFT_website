...
export const COURSES = {
  eyebrow: 'COURSES',
  title: '研修内容',
  note: '各研修とも 実訓練時間12時間（全6回・1回2時間）・同時双方向型で実施します。',
  items: [
    {
      nameParts: ['AIを、自分専属の', '営業コーチにする'],
      description: '生成AIを活用し、商談記録の要約と分析・自社の表現に沿った応対文言の作成の手法を学ぶ営業担当者向け訓練。',
      modules: [
        { title: '商談をAIに読ませる', hours: '4時間' },
        { title: '記録から自分の型を読む', hours: '4時間' },
        { title: '応対を作り直して続ける', hours: '4時間' },
      ],
    },
    {
      ...
      modules: [
        { title: '自分の記録をAIに読ませる', hours: '4時間' },
        { title: '対話と記録の差を見る', hours: '4時間' },
        { title: '記録を整えて続ける', hours: '4時間' },
      ],
    },
    {
      ...
      modules: [
        { title: '自分の数字をAIに読ませる', hours: '4時間' },
        { title: '落ちている理由を絞る', hours: '4時間' },
        { title: '打つ手を決めて測る', hours: '4時間' },
      ],
    },
  ],
} as const;
