  ...
  return (
    <section className="relative bg-ai-bg py-20 md:py-28 lg:py-32">
      <div className="mx-auto max-w-container px-4 md:px-6 lg:px-8">
        ...
        <div className="mx-auto mt-14 max-w-3xl divide-y divide-ai-border border-y border-ai-border">
          {FAQ.items.map((item) => (
            <details key={item.question} className="group py-2">
              ...
              <p
                className="pb-5 pr-10 font-sans text-[16px] font-light text-ai-muted"
