        ...
        <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
          {LOGO_WALL.tiles.map((tile, i) => (
            <Reveal
              ...
              delay={(i % 4) * 70}
              className="flex h-[120px] flex-col items-center justify-center gap-2 border border-[#E2E8F2] bg-white shadow-[0_1px_3px_rgba(12,14,26,0.06)] transition-all duration-300 hover:-translate-y-0.5 hover:border-[#2563EB] hover:shadow-[0_10px_20px_rgba(37,99,235,0.12)]"
            >
              {tile.logoSrc ? (
                <Image
                  src={tile.logoSrc}
