...
| 3 | Pricing | `#pricing` | **折半 — the fold** — the ledger (216 + 38 + 27 + 18 = 299) typeset plainly, then the 299万円 sheet folds in half on a hinge as you scroll; the back of the flap carries 149.5万円・実質半額 with its condition. Half the sheet, half the price. No strikethrough | paper (the one light section) |
