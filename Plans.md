...
### T-010 DX hero VAT bake pipeline (particles on phones)
- status: cc:WIP
...
- shape decision (2026-05-29): user chose PER-SHAPE bakes with runtime switching (head/logo/pet) — 3 captures, runtime morph blending. Most interactive option.
- phases:
